<template>
      <div class="OnlineAppInfSearchList">
          <ul>
            <li v-for="(item1,index) in dateList" :key="index">
              <div class="li-l" >
                  <img :src="checkImg(item1.app_logo)" alt=""  @click="onlineAppSearchClick(item1.ID)">
              </div>
              <div  class="li-r">
        ...
        <!--分页-->
        <div class="OnlineAppInfSearchList_page">
          <div class="block">
            <el-pagination
                    background
    ...
    export default {
        ...
        methods:{
            ...
            getPageDate:function () {
                var _that  = this;
                _that.$axios.post(serviceUrl + 'xxcx',
                    _that.qs.stringify({
