<template>
  <div class="onlineAppShippingCompanyList">
    <ul>
    ...
    <!--分页-->
    <div class="onlineAppShippingCompanyList_page">
      <div class="block">
        <el-pagination
          background
...
<script>
  ...
  export default {
    name: "OnlineAppShippingCompanyList",
    data(){
      return{
          currentPage:1,
          pageSize:null,
...
<style  lang = scss scoped>
  .onlineAppShippingCompanyList{
    ...
    .onlineAppShippingCompanyList_page{
      margin-bottom: 50px;
    }
  }
</style>
