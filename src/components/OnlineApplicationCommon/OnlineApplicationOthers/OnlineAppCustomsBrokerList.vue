<template>
  <div class="onlineAppCustomsBrokerList">
    <ul>
    ...
    <!--分页-->
    <div class="onlineAppCustomsBrokerList_page">
      <div class="block">
        <el-pagination
          background
...
<script>
  ...
  export default {
    name: "OnlineAppCustomsBrokerList",
    data(){
      return{
          currentPage:1,
          pageSize:null,
...
<style  lang = scss scoped>
  .onlineAppCustomsBrokerList{
    ...
    .onlineAppCustomsBrokerList_page{
      margin-bottom: 50px;
    }
  }
</style>
