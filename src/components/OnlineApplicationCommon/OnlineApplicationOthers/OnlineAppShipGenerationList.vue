<template>
  <div class="onlineAppShipGenerationList">
    <ul>
    ...
    <!--分页-->
    <div class="onlineAppShipGenerationList_page">
      <div class="block">
        <el-pagination
          background
...
<script>
  ...
  export default {
    name: "OnlineAppShipGenerationList",
    data(){
      return{
          currentPage:1,
          pageSize:null,
...
<style  lang = scss scoped>
  .onlineAppShipGenerationList{
    ...
    .onlineAppShipGenerationList_page{
      margin-bottom: 50px;
    }
  }
</style>
