<template>
  <div class="onlineAppCommodityBrokerList">
    <ul>
    ...
    <!--分页-->
    <div class="onlineAppCommodityBrokerList_page">
      <div class="block">
        <el-pagination
          background
...
<script>
  ...
  export default {
    name: "OnlineAppCommodityBrokerList",
    data(){
      return{
          currentPage:1,
          pageSize:null,
...
<style  lang = scss scoped>
  .onlineAppCommodityBrokerList{
    ...
    .onlineAppCommodityBrokerList_page{
      margin-bottom: 50px;
    }
  }
</style>
