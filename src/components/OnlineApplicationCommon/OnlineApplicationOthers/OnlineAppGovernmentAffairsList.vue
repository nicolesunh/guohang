<template>
  <div class="onlineAppGovernmentAffairsList">
    <ul>
    ...
    <!--分页-->
    <div class="onlineAppGovernmentAffairsList_page">
      <div class="block">
        <el-pagination
          background
...
<script>
  ...
  export default {
    name: "OnlineAppGovernmentAffairsList",
    data(){
      return{
          currentPage:1,
          pageSize:null,
      ...
      methods:{
          ...
          getPageDate:function () {
              var _that  = this;
              _that.$axios.post(serviceUrl + 'qyyy',
                  _that.qs.stringify({
                      type:"zw",
...
<style  lang = scss scoped>
  .onlineAppGovernmentAffairsList{
    min-height: 500px;
    ul{
      overflow: hidden;
      li{
    ...
    .onlineAppGovernmentAffairsList_page{
      margin-bottom: 50px;
    }
  }
</style>
