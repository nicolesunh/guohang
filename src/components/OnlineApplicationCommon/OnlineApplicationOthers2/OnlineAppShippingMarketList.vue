<template>
  <div class="OnlineAppShippingMarketList">
    <ul>
    ...
    <!--分页-->
    <div class="OnlineAppShippingMarketList_page">
      <div class="block">
        <el-pagination
                background
...
<script>
  ...
  export default {
    name: "OnlineAppShippingMarketList",
    data(){
        return{
            currentPage:1,
            pageSize:null,
...
<style lang = scss scoped>
  .OnlineAppShippingMarketList{
    ...
    .OnlineAppShippingMarketList_page{
      margin-bottom: 50px;
    }
  }
</style>
