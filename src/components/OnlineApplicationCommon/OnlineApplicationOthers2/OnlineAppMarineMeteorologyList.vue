<template>
  <div class="OnlineAppMarineMeteorologyList">
    <ul>
    ...
    <!--分页-->
    <div class="OnlineAppMarineMeteorologyList_page">
      <div class="block">
        <el-pagination
                background
...
<script>
  ...
  export default {
    name: "OnlineAppMarineMeteorologyList",
    data(){
        return{
            currentPage:1,
            pageSize:null,
...
<style lang = scss scoped>
  .OnlineAppMarineMeteorologyList{
    ul{
      overflow: hidden;
      li{
        float: left;
    ...
    .OnlineAppMarineMeteorologyList_page{
      margin-bottom: 50px;
    }
  }
</style>
