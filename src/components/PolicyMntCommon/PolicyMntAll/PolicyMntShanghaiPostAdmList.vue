<template>
  <div class="policyMntShanghaiPostAdmList">
    <ul>
    ...
    <!--分页-->
    <div class="policyMntShanghaiPostAdmList_page">
      <div class="block">
        <el-pagination
          background
...
<script>
  export default {
    name: "PolicyMntShanghaiPostAdmList",
    data(){
      return{
          currentPage:1,
          totalCount:null,
...
<style lang = scss scoped>
  ...
  .policyMntShanghaiPostAdmList_page{
    margin-bottom: 50px;
  }
</style>
