<template>
  <div class="policyMntCommunicationsList">
    <ul>
    ...
    <!--分页-->
    <div class="policyMntCommunicationsList_page">
      <div class="block">
        <el-pagination
          background
...
<script>
  export default {
    name: "PolicyMntCommunicationsList",
    data(){
      return{
          currentPage:1,
          totalCount:null,
...
<style lang = scss scoped>
  ...
  .policyMntCommunicationsList_page{
    margin-bottom: 50px;
  }
</style>
