<template>
  <div class="policyMntChineseGovernmentList">
    <ul>
    ...
    <!--分页-->
    <div class="policyMntChineseGovernmentList_page">
      <div class="block">
        <el-pagination
          background
...
<script>
  export default {
    name: "PolicyMntChineseGovernmentList",
    data(){
      return{
          currentPage:1,
          totalCount:null,
...
<style lang = scss scoped>
  .policyMntChineseGovernmentList{
    min-height: 500px;
    ul{
      padding-right: 15px;
      li{
  ...
  .policyMntChineseGovernmentList_page{
    margin-bottom: 50px;
  }
</style>
