<template>
  <div class="policyMntAviationList">
    <ul>
      <li v-for="(item1,index) in dateList" :key="index">
        ...
        <p class="li-bd">
          ...
          <span @click="policyClick()"><img src="../../.././assets/img/readmore.png" alt=""></span>
        </p>
        <p>
          ...
          <span><a :href="item1.source_link" style="color: #a2a2a2;">{{formatDate(item1.source)}}</a></span>
        </p>
      </li>
    </ul>
    <!--分页-->
    <div class="policyMntAviationList_page">
      <div class="block">
        <el-pagination
          background
