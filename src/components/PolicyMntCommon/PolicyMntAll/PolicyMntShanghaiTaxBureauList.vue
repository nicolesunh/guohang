<template>
  <div class="policyMntShanghaiTaxBureauList">
    <ul>
    ...
    <!--分页-->
    <div class="policyMntShanghaiTaxBureauList_page">
      <div class="block">
        <el-pagination
          background
...
<script>
  export default {
    name: "PolicyMntShanghaiTaxBureauList",
    data(){
      return{
          currentPage:1,
          totalCount:null,
...
<style lang = scss scoped>
  .policyMntShanghaiTaxBureauList{
    min-height: 500px;
    ul{
      padding-right: 15px;
      li{
  ...
  .policyMntShanghaiTaxBureauList_page{
    margin-bottom: 50px;
  }
</style>
