<template>
     <div class="infCenterTechnology1">
        <div class="infCenterTechnology1-list">
          <ul class="">
       ...
       <!--分页-->
       <div class="infCenterTechnology1_page">
         <div class="block">
           <el-pagination
             background
    ...
    export default {
        ...
        methods:{
            ...
            getPageDate:function () {
                var _that  = this
                _that.$axios.post(serviceUrl + 'zxzx_kj',
                    _that.qs.stringify({
...
<style lang = scss scoped>
  .infCenterTechnology1{
     width: 75%;
     float: left;
     .infCenterTechnology1-list{
       min-height: 500px;
       ul{
         padding-right: 15px;
         li{
