<template>
     <div class="infCenterTrade1">
        <div class="infCenterTrade1-list">
          <ul class="">
       ...
       <!--分页-->
       <div class="infCenterTrade1_page">
         <div class="block">
           <el-pagination
             background
    ...
    export default {
        ...
        methods:{
            ...
            getPageDate:function () {
                var _that  = this
                _that.$axios.post(serviceUrl + 'zxzx_jm',
                    _that.qs.stringify({
