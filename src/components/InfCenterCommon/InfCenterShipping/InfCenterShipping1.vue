<template>
     <div class="infCenterShipping1">
        <div class="infCenterShipping1-list">
          <ul class="">
       ...
       <!--分页-->
       <div class="infCenterShipping1_page">
         <div class="block">
           <el-pagination
             background
    ...
    export default {
        ...
        methods:{
            ...
            getPageDate:function () {
                var _that  = this
                _that.$axios.post(serviceUrl + 'zxzx_hy',
                    _that.qs.stringify({
