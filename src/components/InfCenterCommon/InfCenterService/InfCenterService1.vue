<template>
     <div class="infCenterService1">
        <div class="infCenterService1-list">
          <ul class="">
       ...
       <!--分页-->
       <div class="infCenterService1_page">
         <div class="block">
           <el-pagination
             background
    ...
    export default {
        ...
        methods:{
            ...
            getPageDate:function () {
                var _that  = this
                _that.$axios.post(serviceUrl + 'zxzx_fw',
                    _that.qs.stringify({
