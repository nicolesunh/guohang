<template>
  <div class="shipMarketTankerList">
    <div class="shipMarketTankerList-list">
      <ul class="">
    ...
    <!--分页-->
    <div class="shipMarketTankerList_page">
      <div class="block">
        <el-pagination
          background
    ...
    data(){
      ...
      methods:{
          ...
          getPageDate:function () {
              var _that  = this
              _that.$axios.post(serviceUrl + 'hysc_ylsc',
                  _that.qs.stringify({
...
<style lang = scss scoped>
  .shipMarketTankerList{
    .shipMarketTankerList-list{
      min-height: 500px;
      ul{
        padding-right: 15px;
        li{
