<template>
  <div class="shipMarketDryCargoList">
    <div class="shipMarketDryCargoList-list">
      <ul class="">
    ...
    <!--分页-->
    <div class="shipMarketDryCargoList_page">
      <div class="block">
        <el-pagination
          background
  ...
  export default {
    ...
    methods:{
        ...
        getPageDate:function () {
            var _that  = this
            _that.$axios.post(serviceUrl + 'hysc_gshsc',
                _that.qs.stringify({
...
<style lang = scss scoped>
  .shipMarketDryCargoList{
    .shipMarketDryCargoList-list{
      min-height: 500px;
      ul{
        padding-right: 15px;
        li{
