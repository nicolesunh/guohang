<template>
  <div class="FundLogin">
        <h3>
          <router-link to="">
            <img src="../.././assets/img/W-logo-fund.png" alt="">
          </router-link>
        </h3>
        <div class="FundLogin-box">
          <div class="FundLogin-box-login">
            <el-form class="login-form" ref="loginRuleForm" :model="loginRuleForm" :rules="loginRules" label-width="70px">
                  <el-form-item label="账号" prop="username">
                    <el-input v-model="loginRuleForm.username"  placeholder="证件号/手机号/邮箱"></el-input>
                  </el-form-item>
                                        ...
                                        _that.$axios({
                                            ...
                                            if (res.status == 200) {
                                                if (res2.data.flag == "T") {
                                                    ...
                                                    this.getCaptcha();
                                                    this.$message.error(res2.data.errorInfo);
                                                }
                                            }
                                        });
                                    }else {
