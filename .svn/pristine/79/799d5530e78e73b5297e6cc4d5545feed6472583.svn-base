<template>
  <div class="shipMarketContainerList">
    <div class="shipMarketContainerList-list">
      <ul class="">
    ...
    <!--分页-->
    <div class="shipMarketContainerList_page">
      <div class="block">
        <el-pagination
          background
    ...
    data(){
      ...
      methods:{
          ...
          getPageDate:function () {
              var _that  = this
              _that.$axios.post(serviceUrl + 'hysc_jzxsc',
                  _that.qs.stringify({
...
<style lang = scss scoped>
  .shipMarketContainerList{
    .shipMarketContainerList-list{
      min-height: 500px;
      ul{
        padding-right: 15px;
        li{
