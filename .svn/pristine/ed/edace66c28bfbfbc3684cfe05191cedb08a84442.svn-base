<template>
  <div class="shipMarketComprehensiveList">
    <div class="shipMarketComprehensiveList-list">
      <ul class="">
    ...
    <!--分页-->
    <div class="shipMarketComprehensiveList_page">
      <div class="block">
        <el-pagination
          background
...
<script>
  export default {
    name: "ShipMarketComprehensiveList",
    data(){
      return{
        currentPage:1,
        pageSize:null,
    ...
    methods:{
        ...
        getPageDate:function () {
            var _that  = this
            _that.$axios.post(serviceUrl + 'hysc_hyzs',
                _that.qs.stringify({
...
<style lang = scss scoped>
  .shipMarketComprehensiveList{
     .shipMarketComprehensiveList-list{
      min-height: 500px;
      ul{
        padding-right: 15px;
        li{
  ...
  .shipMarketComprehensiveList_page{
    margin-bottom: 50px;
  }
</style>
