<template>
  <div class="policyMntShanghaiCustomsList">
    <ul>
    ...
    <!--分页-->
    <div class="policyMntShanghaiCustomsList_page">
      <div class="block">
        <el-pagination
          background
...
<script>
  export default {
    name: "PolicyMntShanghaiCustomsList",
    data(){
      return{
          currentPage:1,
          totalCount:null,
...
<style lang = scss scoped>
  ...
  .policyMntShanghaiCustomsList_page{
    margin-bottom: 50px;
  }
</style>
