<template>
  <div class="shipMarketEconomyTradeList">
    <div class="shipMarketEconomyTradeList-list">
      <ul class="">
    ...
    <!--分页-->
    <div class="shipMarketEconomyTradeList_page">
      <div class="block">
        <el-pagination
          background
...
<script>
  export default {
    name: "ShipMarketEconomyTradeList",
    data(){
      return{
        currentPage:1,
        pageSize:null,
    ...
    methods:{
        ...
        getPageDate:function () {
            var _that  = this
            _that.$axios.post(serviceUrl + 'hysc_jmtj',
                _that.qs.stringify({
...
<style lang = scss scoped>
  .shipMarketEconomyTradeList{
    .shipMarketEconomyTradeList-list{
      min-height: 500px;
      ul{
        padding-right: 15px;
        li{
  ...
  .shipMarketEconomyTradeList_page{
    margin-bottom: 50px;
  }
</style>
