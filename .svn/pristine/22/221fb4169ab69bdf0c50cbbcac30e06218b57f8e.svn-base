<template>
     <div class="infCenterShanghai1">
        <div class="infCenterShanghai1-list">
          <ul class="">
       ...
       <!--分页-->
       <div class="infCenterShanghai1_page">
         <div class="block">
           <el-pagination
             background
    ...
    export default {
       ...
       methods:{
          ...
          getPageDate:function () {
              var _that  = this
              _that.$axios.post(serviceUrl + 'zxzx_sh',
                  _that.qs.stringify({
