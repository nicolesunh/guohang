<template>
  <div class="policyMntCivilChinaList">
    <ul>
    ...
    <!--分页-->
    <div class="policyMntCivilChinaList_page">
      <div class="block">
        <el-pagination
          background
