<template>
  <div class="shipMarketLogisticsList">
    <div class="shipMarketLogisticsList-list">
      <ul class="">
    ...
    <!--分页-->
    <div class="shipMarketLogisticsList_page">
      <div class="block">
        <el-pagination
          background
  ...
  export default {
    ...
    methods:{
        ...
        getPageDate:function () {
            var _that  = this
            _that.$axios.post(serviceUrl + 'hysc_wltj',
                _that.qs.stringify({
...
<style lang = scss scoped>
  .shipMarketLogisticsList{
    .shipMarketLogisticsList-list{
      min-height: 500px;
      ul{
        padding-right: 15px;
        li{
