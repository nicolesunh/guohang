<template>
  <div class="OnlineAppInspectionQuarantineList">
    <ul>
    ...
    <!--分页-->
    <div class="OnlineAppInspectionQuarantineList_page">
      <div class="block">
        <el-pagination
                background
...
<script>
  ...
  export default {
    name: "OnlineAppInspectionQuarantineList",
    data(){
        return{
            currentPage:1,
            pageSize:null,
...
<style lang = scss scoped>
  .OnlineAppInspectionQuarantineList{
    ul{
      overflow: hidden;
      li{
        float: left;
    ...
    .OnlineAppInspectionQuarantineList_page{
      margin-bottom: 50px;
    }
  }
</style>
