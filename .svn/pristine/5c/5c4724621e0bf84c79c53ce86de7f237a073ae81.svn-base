<template>
  <div class="onlineAppShipDynamicsList">
    <ul>
    ...
    <!--分页-->
    <div class="onlineAppShipDynamicsList_page">
      <div class="block">
        <el-pagination
          background
...
<script>
  ...
  export default {
    name: "OnlineAppShipDynamicsList",
    data(){
      return{
          currentPage:1,
          pageSize:null,
...
<style  lang = scss scoped>
  .onlineAppShipDynamicsList{
    ...
    .onlineAppShipDynamicsList_page{
      margin-bottom: 50px;
    }
  }
</style>
