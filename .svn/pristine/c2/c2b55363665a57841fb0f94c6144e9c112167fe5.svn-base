<template>
  <div class="policyMntShanghaiGovernmentList">
    <ul>
    ...
    <!--分页-->
    <div class="policyMntShanghaiGovernmentList_page">
      <div class="block">
        <el-pagination
          background
...
<script>
  export default {
    name: "PolicyMntShanghaiGovernmentList",
    data(){
      return{
          currentPage:1,
          totalCount:null,
...
<style lang = scss scoped>
  .policyMntShanghaiGovernmentList{
    min-height: 500px;
    ul{
      padding-right: 15px;
      li{
  ...
  .policyMntShanghaiGovernmentList_page{
    margin-bottom: 50px;
  }
</style>
