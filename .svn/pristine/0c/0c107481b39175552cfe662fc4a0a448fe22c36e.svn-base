<template>
  <div class="onlineAppCrossRegionalList">
    <ul>
    ...
    <!--分页-->
    <div class="onlineAppClearanceList_page">
      <div class="block">
        <el-pagination
          background
...
<script>
  ...
  export default {
    name: "OnlineAppCrossRegionalList",
    data(){
      return{
          currentPage:1,
          pageSize:null,
...
<style  lang = scss scoped>
  .onlineAppCrossRegionalList{
    ...
    .onlineAppCrossRegionalList_page{
      margin-bottom: 50px;
    }
  }
</style>
