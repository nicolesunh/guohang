<template>
  <div class="OnlineAppTransportMeansList">
    <ul>
    ...
    <!--分页-->
    <div class="OnlineAppTransportMeansList_page">
      <div class="block">
        <el-pagination
                background
...
<script>
  ...
  export default {
    name: "OnlineAppTransportMeansList",
    data(){
        return{
            currentPage:1,
            pageSize:null,
...
<style lang = scss scoped>
  .OnlineAppTransportMeansList{
    ...
    .OnlineAppTransportMeansList_page{
      margin-bottom: 50px;
    }
  }
</style>
