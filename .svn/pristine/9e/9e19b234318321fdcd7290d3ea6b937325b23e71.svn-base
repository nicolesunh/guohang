<template>
  <div class="OnlineAppScheduledFlightsList">
    <ul>
    ...
    <!--分页-->
    <div class="OnlineAppScheduledFlightsList_page">
      <div class="block">
        <el-pagination
                background
...
<script>
  ...
  export default {
    name: "OnlineAppScheduledFlightsList",
    data(){
        return{
            currentPage:1,
            pageSize:null,
...
<style lang = scss scoped>
  .OnlineAppScheduledFlightsList{
    ...
    .OnlineAppScheduledFlightsList_page{
      margin-bottom: 50px;
    }
  }
</style>
